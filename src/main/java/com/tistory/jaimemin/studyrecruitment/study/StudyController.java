...
import com.tistory.jaimemin.studyrecruitment.study.form.StudyForm;
import com.tistory.jaimemin.studyrecruitment.study.validator.StudyFormValidator;
...
public class StudyController {
    ...
    public String newStudySubmit(@CurrentAccount Account account
        ...
        return "redirect:/study/"
                + URLEncoder.encode(newStudy.getPath(), StandardCharsets.UTF_8);
    }
    ...
    public String viewStudyMembers(@CurrentAccount Account account
            , @PathVariable String path
            , Model model) {
        model.addAttribute(account);
        model.addAttribute(studyService.getStudy(path));
    ...
    public String joinStudy(@CurrentAccount Account account
            , @PathVariable String path) {
    ...
    public String leaveStudy(@CurrentAccount Account account
            , @PathVariable String path) {
        Study study = studyRepository.findStudyWithMembersByPath(path);
